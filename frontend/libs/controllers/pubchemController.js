...
import Pubchem from "../models/pubchem";
...
class PubchemFactory {
  ...
  static parse(json) {
    ...
    let pubchem = new Pubchem(cid, smiles, name, formula, mass, logp,
                              heavy_atoms, atom_chiral, tautomers,
  ...
  static async searchByName(name) {
    let url = "https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/name/<NAME>/json";
